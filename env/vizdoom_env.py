...
class VizDoomEnv():
    ...
    def get_action_list(self, game):
        ...
        return [[False, False, False, False, False, True, False], [False, False, False, False, False, False, True], [False, False, False, True, False, False, False], [False, False, True, False, False, False, False]]
...
def initialize_args(args):
    ...
    args.frame_repeat = 8    # how many frames to repeat in ale for one predicted action
    ...
    #args.screen_history = 3    # input screen history
