...
class ModelTorcs(Model):
    def build_network(self, name, network, trainable, action_type_no):
        ...
        with tf.variable_scope(name):
            ...
            # Second layer convolves 32 6x6 filters with stride 3 with relu
            W_actor_conv1, b_actor_conv1 = self.make_layer_variables([6, 6, self.history_len, 32], trainable, "actor_conv1")
            ...
            W_actor_conv2, b_actor_conv2 = self.make_layer_variables([3, 3, 32, 32], trainable, "actor_conv2")
            ...
            # Third layer convolves 32 3x3 filters with stride 2 with relu
            W_actor_conv3, b_actor_conv3 = self.make_layer_variables([3, 3, 32, 32], trainable, "actor_conv3")
            ...
            # Second layer convolves 32 6x6 filters with stride 3 with relu
            W_critic_conv1, b_critic_conv1 = self.make_layer_variables([6, 6, self.history_len, 32], trainable, "critic_conv1")
            ...
            # Third layer convolves 32 3x3 filters with stride 2 with relu
            W_critic_conv2, b_critic_conv2 = self.make_layer_variables([3, 3, 32, 32], trainable, "critic_conv2")
            ...
            # Third layer convolves 32 3x3 filters with stride 2 with relu
            W_critic_conv3, b_critic_conv3 = self.make_layer_variables([3, 3, 32, 32], trainable, "critic_conv3")
            ...
            W_critic_fc1, b_critic_fc1 = self.make_layer_variables([conv_out_size + action_type_no, 200], trainable, "critic_fc1")
            ...
            W_critic_fc2, b_critic_fc2 = self.make_layer_variables([200, 200], trainable, "critic_fc2")
            self.h_critic_fc2 = tf.nn.relu(tf.matmul(self.h_critic_fc1, W_critic_fc2) + b_critic_fc2, name="h_critic_fc2")
            self.print_log(self.h_critic_fc2)
    
            weight_range = 3 * 10 ** -4    
            W_critic_fc3, b_critic_fc3 = self.make_layer_variables([200, self.action_type_no], trainable, "critic_fc3", weight_range)    
        ...
        self.actor_vars = [W_actor_conv1, b_actor_conv1, W_actor_conv2, b_actor_conv2, W_actor_conv3, b_actor_conv3, W_actor_fc1, b_actor_fc1, W_actor_fc2, b_actor_fc2, W_steering, b_steering, W_acc, b_acc, W_brake, b_brake]
        self.critic_vars = [W_critic_conv1, b_critic_conv1, W_critic_conv2, b_critic_conv2, W_critic_conv3, b_critic_conv3, W_critic_fc1, b_critic_fc1, W_critic_fc2, b_critic_fc2, W_critic_fc3, b_critic_fc3]
